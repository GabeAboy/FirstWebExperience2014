...
<fieldset  class="listbox">	
    <label for="lstMountains">What would you change?</label>
    <select id="lstMountains" 
            name="lstMountains" 
            tabindex="520" >
        <option <?php if($mountain=="HayStack Mountain") print " selected "; ?>
            value="HayStack Mountain">Background</option>
        
        <option <?php if($mountain=="Camels Hump") print " selected "; ?>
            value="Camels Hump">Font</option>
        
        <option <?php if($mountain=="Laraway Mountain") print " selected "; ?>
            value="Laraway Mountain">Design</option>
        
        <option <?php if($mountain=="Laraway Mountain") print " selected "; ?>
            value="Laraway Mountain">Everything</option>
        
        <option <?php if($mountain=="Laraway Mountain") print " selected "; ?>
            value="Laraway Mountain">Nothing</option>
    </select>
</fieldset>
    </body>
</html>
